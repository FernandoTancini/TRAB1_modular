/***************************************************************************
*  $MCI Módulo de implementação: TSTSTLIS Teste lista de sÌmbolos
*
*  Arquivo gerado:              TESTELISTA.c
*  Letras identificadoras:      TSTSTLIS
*
...
*	    1		    jfr	     02/jul/2019  início desenvolvimento
*
***************************************************************************/
...
/* comandos DEBUG */
const char VERIFICA_CMD     [] = "verificarlista";
const char DETURPA_CMD      [] = "deturparlista";
   ...
   TST_tpCondRet TST_EfetuarComando( char * ComandoTeste ) {
      ...
      /* LIS  &Avançar elemento */
       ...
       /* deturpar lista */
            ...
            numLidos = LER_LerParametros("ii", &inxLista, &esperado);
            if ( ( numLidos != 2 )
                ||  ! ValidarInxLista( inxLista, NAO_VAZIO) ) {
                return TST_CondRetParm ;
            } /* if */
            LIS_DeturparLista(vTListas[inxLista], esperado);
            return TST_CondRetOK;
       ...
       /* verificar lista*/
        ...
        }/* fim ativa: LIS &verifica lista */
#endif
      return TST_CondRetNaoConhec ;

   } /* Fim função: TSTLIS &Testar lista */
...
/***********************************************************************
*
*  $FC Função: TSTLIS -Destruir valor
*
***********************************************************************/
   ...
   } /* Fim função: TSTLIS -Destruir valor */


/***********************************************************************
*
*  $FC Função: TSTLIS -Validar indice de lista
*
***********************************************************************/
   ...
   } /* Fim função: TSTLIS -Validar indice de lista */

/********** Fim do módulo de implementação: TSTLIS Teste lista de sÌmbolos **********/
